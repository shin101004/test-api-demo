...
const Toprated = () => {
  ...
  const [url, setUrl] = useState<string>('https://api.themoviedb.org/3/tv/top_rated?api_key=9a735f45eff9846b9afeee748729ddaf');
  const [link, setLink] = useState<ILink | any>({
    language : '',
    page : ''
  });
  const baseUrl = 'https://api.themoviedb.org/3/tv/top_rated?api_key=9a735f45eff9846b9afeee748729ddaf';
